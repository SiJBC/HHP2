...
import {Treatment, Age, ActivityLevel, UserStory, Source, FormBtn} from "./userForm"
...
return(
    <Container fluid>
        <Row>
            ...
            <Col size="md-6">
                <Jumbotron>
                    <h1>Headache treated without pharmaceutical form
                    </h1>
...
export default headacheNoPharmForm